    ...
    <div class="col-12 col-xl-8">
        <div class="card border-primary">
            <div class="card-header">
                <h5 class="mb-1">Tahap 2 — Input Setoran Resmi</h5>
                <p class="text-body-secondary mb-0">Gunakan hanya setelah dana benar-benar sudah diserahkan kepada pimpinan. Data ini akan mengurangi saldo kas.</p>
            </div>
            <div class="card-body">
                <form action="<?= esc($baseUrl) ?>/setoran/simpan" method="post" id="form-setoran-resmi">
                    <?= csrf_field() ?>
                    <div class="row g-4">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-2 justify-content-end mt-5">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="icon-base bx bx-save me-1"></i>Simpan Setoran Resmi</button>
                    </div>
                </form>
            </div>
        </div>
